...
<div class="subheader normal-bg section-padding">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <h1 class="text-custom-white">Service Detail</h1>
          <ul class="custom-flex justify-content-center">
            <li class="fw-500"> <a href="{{route('index')}}" class="text-custom-white">Home</a> </li>
            <li class="fw-500"> <a href="{{route('services')}}" class="text-custom-white">Services</a> </li>
            <li class="active fw-500"> Service Detail </li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="row">
              <div class="col-lg-8">
                <div class="detail-slider-for mb-xl-20 magnific-gallery">
                  <div class="slide-item"> <a href="assets/images/service/service-detal.jpg" class="popup"> <img src="assets/images/service/service-detal.jpg" class="image-fit" alt="img"> </a> </div>
                </div>
                <hr>
                          ...
                          <div class="row">
                            <div class="col-12">
                              <div class="information">
                                <h4 class="text-custom-black">Courier Rental Information</h4>
                        ...
                        <div class="row no-margin">
                          <div class="col-md-6">
                            <div class="tags-box"> <span class="fs-18 text-light-dark"><i class="fas fa-tags"></i></span>
                              <div class="tags"> <a href="#">Courier</a> <a href="#">Express</a> <a href="#">Mover</a> </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                      ...
                      <div class="comment-box section-padding-top p-relative">
                        <div id="comment-box">
                          ...
                          <ul class="comments custom">
                            <li class="comment">
                              <article>
                                <div class="comment-avatar"> <img src="assets/images/datal-team-3.jpg" class="rounded-circle" alt="comment"> </div>
                                <div class="comment-content">
                                  <div class="comment-meta">
                                    ...
                                    <div class="comment-meta-reply"> <a href="#" class="comment-reply-link pricingTable-signup"><i class="fas fa-reply"></i></a> </div>
                                  </div>
                                  <div class="comment">
                            ...
                            <li class="comment">
                              <article>
                                <div class="comment-avatar"> <img src="assets/images/datal-team-2.jpg" class="rounded-circle" alt="comment"> </div>
                                <div class="comment-content">
                                  <div class="comment-meta">
                                    <div class="comment-meta-header">
                              ...
                              <ul class="children">
                                <li class="comment">
                                  <article>
                                    <div class="comment-avatar"> <img src="assets/images/datal-team-1.jpg" class="rounded-circle" alt="comment"> </div>
                                    <div class="comment-content">
                                      <div class="comment-meta">
                                        <div class="comment-meta-header">
                            ...
                            <form>
                              <div class="row">
                                ...
                                <div class="col-12">
                                  ...
                                  <button type="submit" class="pricingTable-signup">Leave Comment</button>
                                </div>
                              </div>
                            </form>
                          </div>
                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    <div class="courier-grid mb-xl-30">
                      <div class="courier-grid-wrapper bx-wrapper">
                        ...
                        <div class="courier-grid-caption padding-20 bg-custom-white p-relative">
                          <h4 class="title fs-16"><a href="#" class="text-custom-black">Economy</a></h4>
                          <p>Grate explorer of tha truth tha master-bulder of human happines.</p>
                          <div class="action"> <a class="pricingTable-signup" href="#">View</a> <a class="pricingTable-signup" href="#">Book</a> </div>
                        </div>
                      </div>
                    </div>
