        ...
        <div class="wrapper p-3">
            <div class="breadcrumb-links">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Cargo-Inventory</li>
                </ul>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <a href="{{ route('admin.addinventory') }}" class="btn btn-primary">Add-Inventory</a>
                </div>
                ...
                @foreach ($branches as $branch)
                    <div class="col-md-2">
                        <a href="{{ route('admin.branchinventory',['name'=>$branch->name]) }}" class="btn btn-primary">{{$branch->name}}</a>
                    </div>
                @endforeach
                @endif
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <div class="card-title">Invoentory List</div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($inventories as $inventory)
                                        <tr>
                                            ...
                                            {{-- <td>{{$inventory->sh_name}}</td> --}}
                                            <td>{{ $inventory->sh_phone }}</td>
                                            <td>{{ $inventory->re_phone }}</td>
                                            <td>{{ $inventory->destination }}</td>
                                            <td>{{ $inventory->order_date }}</td>
                                            <td>{{ $inventory->expected_delivery_date }}</td>
                                            {{-- <td><span class="badge badge-danger">Rejected</span></td> --}}
                                            <td>
                                                <a href="{{ route('admin.showinventory', ['id' => $inventory->id]) }}"
                                                    class="text-dark"><i class="fas fa-eye"></i></a>
                                                @if (Auth()->user()->role_id == 1)
                                                    {{-- <a href="{{route('admin.editinventory')}}" class="text-secondary"><i class="far fa-edit"></i></a> --}}
